...
# compute total number of steps for 4 femtosecond dt
DT_PS=0.004
...
pmemd.cuda -O -i npt1.in -o npt1.out -p $TLEAPDIR/complex_solvated.prmtop -c $NPTDIR/npt.rst -r npt1.rst -x npt1.nc -inf npt1.mdinfo -ref $NPTDIR/npt.rst
